...
public class Connect {
    ...
    public boolean dbConnect() {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:oracle:thin:kamil/Password999@localhost:1521:orcl");
    ...
    public boolean dbInsertPerson(int id, String firstName, String lastName, int salary, String someText) {
        try {
    ...
    public boolean dbInsertAnimal(int id, String name, int ownerID){
        try {
