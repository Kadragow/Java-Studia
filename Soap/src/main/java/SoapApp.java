...
public class SoapApp {
    ...
    private final String HEADER_NAMESPACE_URI = "Header";
    ...
    public List<String> extractPathNodes(SOAPMessage soapMessage) throws SOAPException {
        ...
        Iterator<Node> pathNodeElements = pathNodesElement.getChildElements(new QName(HEADER_NAMESPACE_URI, HEADER_PATH_NODE));
